-- ============================================================
-- 090_login_events_is_native.sql — marca si un inicio de sesión ocurrió
...
-- /api/auth/log-session. Esto permite que "Sesiones recientes" en /admin
-- muestre de un vistazo si el usuario entra desde la app o el navegador —
