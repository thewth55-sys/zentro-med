-- ============================================================
-- 088_login_2fa_and_trusted_devices.sql
--
...
--     ni dejar al usuario logueado antes de pasar el 2FA. Solo lo toca el
...
-- El usuario ve y revoca sus propios dispositivos (para un panel de
