...
import { LayoutDashboard, History, Megaphone, Newspaper, FileText, ShieldCheck, Smartphone, Ticket, Users, UserCog, X } from "lucide-react";
...
const NAV_ITEMS: { href: string; label: string; icon: typeof LayoutDashboard; exact: boolean; roles?: StaffRole[] }[] = [
  ...
  { href: "/admin/facturacom-test", label: "Prueba factura.com", icon: FileText, exact: true },
