...
export function DashboardHero({ nextAppointment, nextAppointmentLoading }: Props) {
  ...
  return (
    ...
    >
      ...
      <div className="relative mt-5 flex flex-wrap items-center gap-3 rounded-xl border border-white/15 bg-white/10 p-3">
        ...
        <Link
          href="/copilot"
          className="inline-flex shrink-0 items-center gap-2 rounded-lg bg-[#22C55E] px-4 py-2 text-sm font-semibold text-[#06210F] transition hover:brightness-105"
        >
