...
export interface DeliverInboundMessageParams {
   ...
   *  supabase/migrations/116_conversations_whatsapp_config.sql. */
...
export async function resolveContactAndConversation(
  ...
  // see migration 116's comment for why this matters once an account
...
async function findOrCreateConversation(
  ...
  // migration 116's comment. `whatsappConfigId` can be null for
