 ...
 * la sesión nativa y no pasan por aquí, así que el 2FA no molesta ni se
 * pide en cada apertura.
 */
export async function POST(request: Request) {
  ...
  // quedarían totalmente bloqueados. Siguen protegiendo el rate-limit por
  // IP+correo, la contraseña y el 2FA por correo. Por defecto es estricto.
