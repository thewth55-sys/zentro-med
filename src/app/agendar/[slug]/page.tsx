...
export default async function PublicBookingPage({
  ...
  // Aplica el color de acento de la clínica sobreescribiendo los tokens del
  // tema en este subárbol (recolorea el widget de reserva completo). Los
  // tokens guardan un valor de color completo (Tailwind v4 var(--primary)),
  // así que un hex se resuelve directamente.
  const accentVars = {
    "--primary": accent,
