...
const eslintConfig = defineConfig([
  ...
  globalIgnores([
    ...
    // that isn't a React hook) don't know that and do fire. Same
    // reasoning already applies to mcp-server/ (excluded implicitly by
    // tsconfig project scope, not explicitly listed here).
    "services/**",
  ]),
]);
